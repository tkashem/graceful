...
- There is a slight rise (less than `5ms`) in APF filter latency with respect to increasing load. More tests need to be
  run to understand if the rise is consistent. 
